...
![cfwk1](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk1.png)

## 安装

Github地址：[https://github.com/donwa/goindex](https://github.com/donwa/goindex)
备份地址：[https://github.com/cyrilsoy/goindex](https://github.com/cyrilsoy/goindex)
...
![cfwk(1)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(1).png)

点进去后新建一个`Workers`子域名，也就是你的专属域名，填入确认后就更改不了了，所以别乱填。

![cfwk(2)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(2).png)

接下来点击`Create a Worker`创建一个`Worker`。

![cfwk(3)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(3).png)

把你之前获取的`Workers`代码粘贴进去，然后可以在左上角双击修改域名，再点击`Save and Deploy`即可。

![cfwk(4)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(4).png)
...
![cfwk(5)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(5).png)

然后在上方找到`Workers`，选择后，点击页面下的`Add route`，进行如下设置。

![cfwk(6)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(6).png)

按照图中的格式，填上自己的域名，并选择对应的`Workers`程序即可。

![cfwk(7)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(7).png)
...
![cfwk(8)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(8).png)
...
![cfwk(9)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(9).png)

然后你会获得自己的客户端`ID`和客户端密钥，再复制下来。

![cfwk(10)](https://cdn.jsdelivr.net/gh/cyrilsoy/hello-blog@main/static/goIndex/cfwk(10).png)
...
`Workers`代码可以点击该地址查看→[传送门](https://github.com/cyrilsoy/goindex/blob/main/index.js)，先复制代码，部分修改可参考上面，不同的是，需要填上自己的`api`信息，如下：
